...
\begin{figure}
    ...
    \begin{tikzpicture}[node distance=3.5cm]
        ...
        \umlemptyclass[y=-10, x=-6]{replicated\_distribution}
        \umlemptyclass[y=-10, x=-1]{systolic\_distribution}
        \umlemptyclass[y=-12, x=2]{shared\_and\_replicated\_distribution}
        \umlemptyclass[y=-10, x=6]{replicated\_systolic\_distribution}
        ...
        \umlreal[geometry=|-|]
            {shared\_and\_replicated\_distribution}{abstract\_distribution}
        \umlreal[geometry=|-|]
