...
\begin{figure}[!ht]
    ...
    \begin{tikzpicture}[scale=.5]
        ...
        % Draw arrows
        \newcommand{\drawArr}[1]{
            \draw [<->, thick] (4 + 6*#1+0.2,2) -- (4 + 6*#1+1.8,2);
        }
        \drawArr{0}
        \drawArr{1}
        \drawArr{2}
...
A further problem arising from this algorithm is that every process has
...
\begin{figure}[!ht]
    ...
    \begin{tikzpicture}
        ...
        %
        % Draw bounding boxes
        \draw [draw, rounded corners] (-1,0) rectangle (1, 1);
        %
        \draw [draw, rounded corners] (2,1) rectangle (3, 3);
        \draw [draw, rounded corners] (4,1) rectangle (5, 3);
        %
        \draw [draw, rounded corners] (6,0) rectangle (8, 1);
        %
        \draw [draw, rounded corners] (4,0) rectangle (5, -2);
        \draw [draw, rounded corners] (2,0) rectangle (3, -2);
        %
        % Draw outer ring
        \smallRectangle{-1}{0}{bluefill}
        %
        \smallRectangle{2}{2}{bluefill}
        \smallRectangle{4}{2}{bluefill}
        %
        \smallRectangle{7}{0}{bluefill}
        %
        \smallRectangle{4}{-2}{bluefill}
        \smallRectangle{2}{-2}{bluefill}
        %
        % Draw inner ring
        \smallRectangle{0}{0}{redfill}
        %
        \smallRectangle{2}{1}{redfill}
        \smallRectangle{4}{1}{redfill}
        %
        \smallRectangle{6}{0}{redfill}
        %
        \smallRectangle{4}{-1}{redfill}
        \smallRectangle{2}{-1}{redfill}
        %
        % Draw circle
        \newcommand{\off}{0.1}
        \path [line] (0.5, 0.5+\off) |- (2.5, 1.5);
        %
        \path [line] (2.5+\off, 1.5) -- (4.5, 1.5);
        \path [line] (4.5+\off, 1.5) -| (6.5, 0.5);
        %
        \path [line] (6.5, 0.5-\off) |- (4.5, -0.5);
        %
        \path [line] (4.5-\off, -0.5) -- (2.5, -0.5);
        \path [line] (2.5-\off, -0.5) -| (0.5, 0.5);
        %
        % Draw labels
